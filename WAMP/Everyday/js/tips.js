	...
	addTips:function(data){
		...
		switch(position)
		{
			...
			case "top":
				...
				btm = '<p style="background:url(' + cur_root + '/image/theme_1/tips.png) no-repeat ' + (width-data.offset-28) + 'px 0px; height:13px"></p>';
		...
		tip = $(this).after(
			'<div class="tips" style="background-position:' + bgLeft + 'px ' + bgTop + 'px; width:' + width + 'px; ' + 
