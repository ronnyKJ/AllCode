...
class PageDefault extends Base {
    // 起始行数
    protected $firstRow	;
    ...
    protected $theme	 =	 '共 %totalRow% 条记录 %nowPage%/%totalPage% 页 %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%';
    ...
    public function show() {
        ...
        $pageStr	 =	 str_replace(
            ...
            array($this->nowPage,$this->totalRows,$this->totalPages,$upPage,$downPage,$theFirst,$prePage,$linkPage,$nextPage,$theEnd),$this->theme);
        return $pageStr;
    }
}
?>