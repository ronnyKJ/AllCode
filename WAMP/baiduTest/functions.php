...
function par_pagenavi($range = 9){
	...
	if($paged != 1){echo "<a href='" . get_pagenum_link(1) . "' class='extend' title='to index'> index </a>";}
    ...
    if($paged != $max_page){echo "<a href='" . get_pagenum_link($max_page) . "' class='extend' title='to end'> last </a>";}}
}
