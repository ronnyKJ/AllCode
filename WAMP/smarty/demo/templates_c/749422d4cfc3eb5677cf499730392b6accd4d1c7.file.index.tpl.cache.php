<?php /* Smarty version Smarty-3.0.8, created on 2011-09-01 15:36:19
         compiled from ".\templates\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:80394e5fa673b80a62-73266827%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '80394e5fa673b80a62-73266827',
  'function' => 
  array (
  ),
  'has_nocache_code' => true,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_capitalize')) include 'H:\WAMP\smarty\libs\plugins\modifier.capitalize.php';
if (!is_callable('smarty_modifier_date_format')) include 'H:\WAMP\smarty\libs\plugins\modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) include 'H:\WAMP\smarty\libs\plugins\function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include 'H:\WAMP\smarty\libs\plugins\function.html_select_time.php';
if (!is_callable('smarty_function_html_options')) include 'H:\WAMP\smarty\libs\plugins\function.html_options.php';
?><?php echo '/*%%SmartyNocache:80394e5fa673b80a62-73266827%%*/<?php if (!is_callable(\'smarty_modifier_capitalize\')) include \'H:\WAMP\smarty\libs\plugins\modifier.capitalize.php\';
if (!is_callable(\'smarty_modifier_date_format\')) include \'H:\WAMP\smarty\libs\plugins\modifier.date_format.php\';
?>/*/%%SmartyNocache:80394e5fa673b80a62-73266827%%*/';?>
...
The value of {$Name} is <b><?php echo '/*%%SmartyNocache:80394e5fa673b80a62-73266827%%*/<?php echo $_smarty_tpl->getVariable(\'Name\')->value;?>
/*/%%SmartyNocache:80394e5fa673b80a62-73266827%%*/';?></b>

variable modifier example of {$Name|upper}

<b><?php echo '/*%%SmartyNocache:80394e5fa673b80a62-73266827%%*/<?php echo ((mb_detect_encoding($_smarty_tpl->getVariable(\'Name\')->value, \'UTF-8, ISO-8859-1\') === \'UTF-8\') ? mb_strtoupper($_smarty_tpl->getVariable(\'Name\')->value,SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable(\'Name\')->value));?>
/*/%%SmartyNocache:80394e5fa673b80a62-73266827%%*/';?></b>
