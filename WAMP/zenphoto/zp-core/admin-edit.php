				...
				<table border="0" class="formlayout" id="image-<?php echo $currentimage; ?>">
					<tr>
						...
						<p style="margin-top: 0; margin-bottom: 1em;">
							...
							printf( gettext("Hit counter: <strong>%u</strong>"),$hc);
							?>
							<label class="checkboxlabel">
								<input type="checkbox" id="reset_hitcounter-<?php  echo $currentimage;?>" name="<?php  echo $currentimage; ?>-reset_hitcounter" value="1" /><?php  echo gettext("Reset"); ?>
							</label>
							 <?php
