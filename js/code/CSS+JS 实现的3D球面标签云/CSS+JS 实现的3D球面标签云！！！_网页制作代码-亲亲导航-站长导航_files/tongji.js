...
{
	var unit_id     = "1454967";
	var client_ip   = "121.14.201.175";
	var server_time = "1319355901";
	var verify_code = "eae5eb63";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1454967/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
