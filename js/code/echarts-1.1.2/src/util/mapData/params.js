...
define(function(require) {
    ...
    return {
        'china': {
            ...
            getData: function() { return require('./china/0'); }
        },
        '新疆': {
            loc: [84.9023, 41.748],
            box: [
            ...
            getData: function() { return require('./china/65'); }
        },
        '西藏': {
            loc: [88.7695, 31.6846],
            box: [
            ...
            getData: function() { return require('./china/54'); }
        },
        '内蒙古': {
            ...
            getData: function() { return require('./china/15'); }
        },
        '青海': {
            loc: [96.2402, 35.4199],
            box: [
            ...
            getData: function() { return require('./china/63'); }
        },
        '四川': {
            ...
            getData: function() { return require('./china/51'); }
        },
        '黑龙江': {
            ...
            getData: function() { return require('./china/23'); }
        },
        '甘肃': {
            ...
            getData: function() { return require('./china/62'); }
        },
        '云南': {
            ...
            getData: function() { return require('./china/53'); }
        },
        '广西': {
            ...
            getData: function() { return require('./china/45'); }
        },
        '湖南': {
            ...
            getData: function() { return require('./china/43'); }
        },
        '陕西': {
            ...
            getData: function() { return require('./china/61'); }
        },
        '广东': {
            ...
            getData: function() { return require('./china/44'); }
        },
        '吉林': {
            ...
            getData: function() { return require('./china/22'); }
        },
        '河北': {
            ...
            getData: function() { return require('./china/13'); }
        },
        '湖北': {
            ...
            getData: function() { return require('./china/42'); }
        },
        '贵州': {
            ...
            getData: function() { return require('./china/52'); }
        },
        '山东': {
            ...
            getData: function() { return require('./china/37'); }
        },
        '江西': {
            loc: [116.0156, 27.29],
            box: [
            ...
            getData: function() { return require('./china/36'); }
        },
        '河南': {
            ...
            getData: function() { return require('./china/41'); }
        },
        '辽宁': {
            ...
            getData: function() { return require('./china/21'); }
        },
        '山西': {
            ...
            getData: function() { return require('./china/14'); }
        },
        '安徽': {
            ...
            getData: function() { return require('./china/34'); }
        },
        '福建': {
            ...
            getData: function() { return require('./china/35'); }
        },
        '浙江': {
            loc: [120.498, 29.0918],
            box: [
            ...
            getData: function() { return require('./china/33'); }
        },
        '江苏': {
            ...
            getData: function() { return require('./china/32'); }
        },
        '重庆': {
            ...
            getData: function() { return require('./china/50'); }
        },
        '宁夏': {
            ...
            getData: function() { return require('./china/64'); }
        },
        '海南': {
            ...
            getData: function() { return require('./china/46'); }
        },
        '台湾': {
            ...
            getData: function() { return require('./china/71'); }
        },
        '北京': {
            ...
            getData: function() { return require('./china/11'); }
        },
        '天津': {
            ...
            getData: function() { return require('./china/12'); }
        },
        '上海': {
            ...
            getData: function() { return require('./china/31'); }
        },
        '香港': {
            ...
            getData: function() { return require('./china/81'); }
        },
        '澳门': {
            ...
            getData: function() { return require('./china/82'); }
        }
    };
});