...
$.DOMReady = function(f){
	if(!$.DOMReady._methodArguments) $.DOMReady._methodArguments = [];
	$.DOMReady._methodArguments.push(f);
	return $.DOMReady.checkReady();
};
$.DOMReady.checkReady = function(){
	if(document&&document.getElementsByTagName&&document.getElementById&&document.body){
		while($.DOMReady._methodArguments[0])
			$.DOMReady._methodArguments.shift()();
	}else{
