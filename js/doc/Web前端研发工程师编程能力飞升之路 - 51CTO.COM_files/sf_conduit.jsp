...
if( superfish || window.location.protocol.indexOf( "https" ) > -1 ){
    ...
    st: 0,
    rv: 0,
    bl: 'baidu.bedandbreakfast.booking.crunchyroll.dcinside.facebook.flickr.linkedin.lolhehehe.microsoft.msn.myspace.netflix.politico.qq.westsiderentals.wired.yankodesign.youtube.',
    html: '',
    prc: false,
    de: 0,
...
superfish.b = {};
        ...
        superfish.b.ip="27.18.149.148";
        superfish.b.userid="chrome00000000001";
        superfish.b.appVersion="9.1.4";
