...
<title>DayPics</title>
<link rel='stylesheet' type='text/css' href='__ROOT__/css/phone.css'>
...
<script type="text/javascript" src="__ROOT__/js/phone.js"></script>
</head>
<body>
<div id="pic_container">
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): ++$i;$mod = ($i % 2 )?><img alt="" src="__ROOT__/pics/<?php echo ($list["filename"]); ?>" width="100%" />
