<?php
class MainFCardMessages_model extends CI_Model {

	const tableName = 'TKCardUserMessage';
    ...
    {
    	$DBCommOper = new DBCommOper();    	
    	return $DBCommOper->GetEntityCount('View_TKCardUserMessage', $where);
    }
    ...
    {
    	$DBCommOper = new DBCommOper();    	
    	return $DBCommOper->GetEntityByPage('View_TKCardUserMessage', $where, $order , $pageSize, $pageIndex);
    }
     ...
     */
    function DoAddCardMessage($entity)
    {
    	$this->db->query('CALL `ProAddCardMessage` ('
    		.'\''.$entity['content'].'\', '
	    	.'\''.$entity['userId'].'\', '
	    	.'\''.$entity['cardId'].'\', '
	    	.'@result); '
