<?php
class MainFshopnews_model extends CI_Model {

	const tableName = 'TKShoppingNews';
    ...
    {
    	$DBCommOper = new DBCommOper();
    	return $DBCommOper->GetEntityCount('View_ShopNews', $where);
    }
    ...
    {
    	$DBCommOper = new DBCommOper();    	
    	return $DBCommOper->GetEntityByPage('View_ShopNews', $where, $order , $pageSize, $pageIndex);
    }
