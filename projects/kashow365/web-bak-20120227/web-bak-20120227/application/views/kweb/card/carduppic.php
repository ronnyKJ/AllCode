...
<form id="test" action="<?php echo site_url("card/dopreview");?>" method="post" target="_blank">
...
-->
<div class="midbut" style="overflow:hidden; width:700px;height:370; ">
	<img alt="Demo2" src="<?php echo $this->config->item('UpPathCard').'temp/'.$uploadedImage;?>"
	 onload="$('#master').remove();$('#c').remove(); new ImageCopper(this,{MaxWidth: 130, MaxHeight: 67, Width: 568, Height:289, Locked : true,Left : 0, Top : 0},{Width:700,Height:700},function(x,y,w,h){ShowValue(x,y,w,h,2)});" 
