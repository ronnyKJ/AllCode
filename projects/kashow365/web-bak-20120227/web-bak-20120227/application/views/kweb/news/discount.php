...
<div class="bigcont">
	<div class="topadv2">
	<form action="<?php echo site_url('news/discount');?>" method="get">
...
<div class="bigcont">
	...
	<div class="leftcont1 martop25">
		<div class="katit2"><div class="kawid160">打折快报</div><div class="kawid330">活动内容</div><div class="kawid125">活动日期</div></div>
        <ul class="kaul10">
        		<?php foreach ($newsData as $row):?>
		<li><h4><a href="<?php echo site_url('news/discountcontent/'.$row['id']);?>" title="<?php echo $row['newsTitle'];?>"><?php echo String::cut($row['newsTitle'],18);?></a></h4>
		<span><a href="<?php echo site_url('news/discountcontent/'.$row['id']);?>" title="<?php echo $row['newsSummary'];?>"><?php echo String::cut($row['newsSummary'],40);?></a></span>
		<em>
