...
function Finish(status, info){
	if(status=="1")
	{
		//alert(obj.info);
		$("#msg").html(info);
		$("#msg").oneTime(1000,"hide", function() {
			$("#msg").html("");
			document.getElementById("button").removeAttribute("disabled"); 
...
<div class="bigcont">
    ...
    <div class="kalist3"><input class="seabut" name="btnbuy" type="button" value="我要买" onclick="MyPupInit()" <?php if($cardUserId==$userId){echo 'disabled="disabled"';}?> />
      <label>
