...
<div id="content">
	...
	<p class="setMrgnLft"><span class="attrName"><?php echo ($vo["name"]); ?>: </span><span class="attrContent">﻿<?php
...
?></span></p>
		<?php else: ?><p class="setMrgnLft"><span class="attrName"><?php echo ($vo["name"]); ?>: </span><span class="attrContent">﻿<?php
	if($list[$i-1]['ctrl_type']=="radiobutton")
	{
		$l = split(" ",$list[$i-1]['label']);
		$j = intval($list[$i-1]['content']); 
