...
(function(){
	var init = function(){
		...
		// 鼠标动作绑定
		var d = document, isMouseDown = false, angle = 0, deltaAngle = 0;
		...
		d[touchstart] = function(e){
			...
			deltaAngle = U.getAngle(eX, eY, currentEquipment) - angle;
		...
		d[touchmove] = function(e){
			...
			if(isMouseDown && Eq.isRotateEquipmentsFlag){
				...
				angle = U.getAngle(eX, eY, currentEquipment) - deltaAngle;
